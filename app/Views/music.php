        ...
        <div class="modal-body">
          ...
          <?php if(isset($plays)): ?>
              <?php foreach($plays as $p): ?>
                  <a href="/selectedplaylist/<?= $p['Playlist_Name']; ?>" class="btn btn-primary" style="text-decoration: none;"><?= $p['Playlist_Name']; ?></a>
...
<audio id="audio" controls autoplay></audio>
  ...
  <?php if ($song): ?>
      <?php foreach ($song as $songs):?>
          <li data-src="<?=base_url(); ?>/music/<?= $songs['Music_Name']; ?>.mp3"><?= $songs['Music_Name']; ?>
  ...
  <?php else:?>
     <?php foreach ($songs as $s):?>
          <li data-src="<?=base_url(); ?>/music/<?= $s['Music_Name']; ?>.mp3"><?= $s['Music_Name']; ?>
           <a href="/addtopplaylist" class ="hover-effect">
            <img src="<?=base_url(); ?>/add.png">
      </a>
    </li>
